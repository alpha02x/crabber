...
const AnomalyDefinitons: Map<string, AnomalyDefinition> = new Map([
	...
	[
		"3FFS",
		{
			name: "C3 Fortification Frontier Stronghold",
			short: "3FFS-",
			basePrice: 41000000,
	...
	[
		"3OFS",
		{
			name: "C3 Outpost Frontier Stronghold",
			short: "3OFS-",
			basePrice: 45100000,
